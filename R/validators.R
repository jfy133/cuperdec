#' Validate taxatable
#'
#' Internal validation of taxon table loaded with `load_taxa_table()`
#'
...
#' Validate taxatable
#'
#' Internal validation of database loaded with `load_database()`
#'
...
#'
#' Internal validation of database loaded with `load_map()`
#'
#' @param metadata a metadata file loaded with `load_map()`
#'
#' @noRd
...
#'
#' Internal validation of filter table loaded with `*_filter()`
#'
#' @param filter_table a filter table generated by a `*_filter()` function
#'
#' @noRd
